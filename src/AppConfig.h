...
public:
    ...
    void setChatLoggingEnabled(bool v)   { m_chatLoggingEnabled = v; save(); emit chatLoggingChanged(v); }
    ...
    void setChatTemplatePreset(ChatTemplate::Preset v) { m_chatTemplatePreset = v; save(); emit chatTemplateChanged(); }
    void setCustomChatTemplate(const QString &v)       { m_customChatTemplate = v; save(); emit chatTemplateChanged(); }
